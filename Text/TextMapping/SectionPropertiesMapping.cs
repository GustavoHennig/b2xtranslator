...
namespace b2xtranslator.txt.TextMapping
{
        ...
        IMapping<SectionPropertyExceptions>
    {
       ...
       private SectionType _type = SectionType.nextPage;
        ...
        /// </summary>
        /// <param name="writer">The IWriter</param>
        public SectionPropertiesMapping(IWriter writer, ConversionContext ctx, int sectionNr)
            : base(writer)
        {
            _ctx = ctx;
            ...
            foreach (var sprm in sepx.grpprl)
            {
                switch (sprm.OpCode)
                {
                    ...
                    case SinglePropertyModifier.OperationCode.sprmSNfcFtnRef:
                        //number format
                        short nfc = BitConverter.ToInt16(sprm.Arguments, 0);
                    ...
                    case SinglePropertyModifier.OperationCode.sprmSNFtn:
                        short nFtn = BitConverter.ToInt16(sprm.Arguments, 0);
                    ...
                    case SinglePropertyModifier.OperationCode.sprmSDxaColWidth:
                        ...
                        short w = BitConverter.ToInt16(sprm.Arguments, 1);
                        _colWidth[index] = w;
                        break;
