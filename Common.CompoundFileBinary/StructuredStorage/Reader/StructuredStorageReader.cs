using b2xtranslator.CompoundFileBinary;
...
namespace b2xtranslator.StructuredStorage.Reader
{
        ...
        IStructuredStorageReader
    {
        ...
        public StructuredStorageReader(Stream stream, ILogger? logger)
        {
            try
            {
            	this._logger = logger ?? DebugLogger.Default;
                ...
                this._directory = new DirectoryTree(this._fat, this._header, this._fileHandler, _logger);
        ...
        public StructuredStorageReader(string fileName, ILogger? logger = null)
        {
            try
            {
                this._logger = logger ?? DebugLogger.Default; 
